				...
				<div class="col-md-6">
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item">
							...
							<span><?php echo esc_html( WLSM_Config::get_money_text( $invoice_amount, $school_id ) ); ?></span>
						</li>
						<li class="list-group-item">
							<span class="wlsm-font-bold"><?php esc_html_e( 'Discount', 'school-management' ); ?>:</span>
							<span><?php echo esc_html( $invoice_discount); ?> %</span>
						</li>
						<li class="list-group-item">
				...
				<div class="col-md-6">
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item">
							...
							<span><?php echo esc_html( WLSM_Config::get_money_text( $due_date_amount, $school_id ) ); ?></span>
						</li>
					</ul>
				</div>
			</div>
