...
<div class="row">
	<div class="col-md-12">
		<div class="text-center wlsm-section-heading-block">
			...
			<span class="float-md-right">
				<a href="<?php echo esc_url( $page_url . '&action=pending_payments' ); ?>" class="btn btn-sm btn-outline-light">
					<i class="fas fa-file-invoice"></i>&nbsp;
					<?php echo esc_html( 'Verify Payments', 'school-management' ); ?>
				</a>&nbsp;
		...
		<div class="wlsm-table-block">
					...
					<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-get-invoices-form" class="mb-3">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="search_students_by" id="wlsm_search_by_date" value="search_by_date">
									<label class="ml-1 form-check-label wlsm-font-bold" for="wlsm_search_by_date">
										<?php esc_html_e( 'Search By Date', 'school-management' ); ?>
									</label>
								</div>
							</div>
						</div>
						...
						<div class="wlsm-search-students wlsm-search-class-students pt-2">
							...
							<div class="wlsm-search-students wlsm-search-date-students pt-2">
								<div class="row">
									<div class="col-md-8 mb-1">
										<div class="h6">
											<span class="text-secondary border-bottom">
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										...
										<input type="text" name="start_date" class="form-control wlsm_invoice_date" id="wlsm_search_keyword" placeholder="<?php esc_attr_e('Enter Search Keyword', 'school-management'); ?>">
									</div>
									<div class="form-group col-md-4">
										<label for="wlsm_search_keyword" class="wlsm-font-bold">
											<?php esc_html_e('End Date', 'school-management'); ?>:
										</label>
										<input type="text" name="end_date" class="form-control wlsm_invoice_date" id="wlsm_search_keyword" placeholder="<?php esc_attr_e('Enter Search Keyword', 'school-management'); ?>">
									</div>
								</div>
							</div>
			...
			<?php
			$delete_invoices = WLSM_M_Role::check_permission( array( 'delete_invoices' ), $current_school['permissions'] );
				if ( $delete_invoices ) {
					$entity = 'invoices';
