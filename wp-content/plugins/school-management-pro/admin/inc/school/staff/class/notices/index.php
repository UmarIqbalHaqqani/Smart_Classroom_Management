		...
		<div class="text-center wlsm-section-heading-block">
			...
			<span class="float-md-right">
				<a href="<?php echo esc_url( $page_url . '&action=save' ); ?>" class="btn btn-sm btn-outline-light">
					...
					<?php echo esc_html( 'Add New Notice', 'school-management' ); ?>
				</a>
			</span>
		</div>
			...
			<table class="table table-hover table-bordered" id="wlsm-notices-table">
				<thead>
					<tr class="text-white bg-primary">
						<th scope="col"><?php esc_html_e( 'Notice', 'school-management' ); ?></th>
						<th scope="col" class="text-nowrap"><?php esc_html_e( 'Link To', 'school-management' ); ?></th>
						...
						<th scope="col"><?php esc_html_e( 'Added By', 'school-management' ); ?></th>
