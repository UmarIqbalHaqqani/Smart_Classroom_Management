...
<button type="button" class="mt-2 btn btn-block btn-primary" data-toggle="collapse" data-target="#wlsm_email_invoice_generated_fields" aria-expanded="true" aria-controls="wlsm_email_invoice_generated_fields">
	<?php esc_html_e( 'Invoice Generated Email Template', 'school-management' ); ?>
</button>
...
<div class="collapse border border-top-0 border-primary p-3" id="wlsm_email_invoice_generated_fields">
		...
		<div class="row">
			<div class="col-md-3">
				<label for="wlsm_email_invoice_generated_enable" class="wlsm-font-bold">
					<?php esc_html_e( 'Invoice Generated Email', 'school-management' ); ?>:
				</label>
			</div>
			<div class="col-md-9">
	...
	<div class="wlsm_email_template wlsm_email_invoice_generated">
		<div class="row">
			<div class="col-md-3">
				<label for="wlsm_email_invoice_generated_subject" class="wlsm-font-bold"><?php esc_html_e( 'Email Subject', 'school-management' ); ?>:</label>
			</div>
			<div class="col-md-9">
				<div class="form-group">
					<input name="email_invoice_generated_subject" type="text" id="wlsm_email_invoice_generated_subject" value="<?php echo esc_attr( $email_invoice_generated_subject ); ?>" class="form-control" placeholder="<?php esc_attr_e( 'Email Subject', 'school-management' ); ?>">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="wlsm_email_template wlsm_email_invoice_generated">
		<div class="row">
			<div class="col-md-3">
				<label for="wlsm_email_invoice_generated_body" class="wlsm-font-bold"><?php esc_html_e( 'Email Body', 'school-management' ); ?>:</label>
			</div>
			<div class="col-md-9">
				<div class="form-group">
					<?php
	...
	<?php
	$email_template = 'invoice_generated';
