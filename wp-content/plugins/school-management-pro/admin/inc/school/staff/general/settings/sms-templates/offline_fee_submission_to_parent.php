...
// SMS Offline Fee Submission To Parent settings.
...
?>
<button type="button" class="mt-2 btn btn-block btn-primary" data-toggle="collapse" data-target="#wlsm_sms_offline_fee_submission_to_parent_fields" aria-expanded="true" aria-controls="wlsm_sms_offline_fee_submission_to_parent_fields">
	<?php esc_html_e( 'Offline Fee Submission To Parent SMS Template', 'school-management' ); ?>
</button>

<div class="collapse border border-top-0 border-primary p-3" id="wlsm_sms_offline_fee_submission_to_parent_fields">

	<div class="wlsm_sms_template wlsm_sms_offline_fee_submission_to_parent">
		<div class="row">
			<div class="col-md-3">
				<label for="wlsm_sms_offline_fee_submission_to_parent_enable" class="wlsm-font-bold">
					<?php esc_html_e( 'Offline Fee Submission To Parent SMS', 'school-management' ); ?>:
				</label>
			</div>
			<div class="col-md-9">
				<div class="form-group">
					<label for="wlsm_sms_offline_fee_submission_to_parent_enable" class="wlsm-font-bold">
						<input <?php checked( $sms_offline_fee_submission_to_parent_enable, true, true ); ?> type="checkbox" name="sms_offline_fee_submission_to_parent_enable" id="wlsm_sms_offline_fee_submission_to_parent_enable" value="1">
	...
	<div class="wlsm_sms_template wlsm_sms_offline_fee_submission_to_parent mb-3">
		<div class="row">
			<div class="col-md-12">
				<span class="wlsm-font-bold text-dark"><?php esc_html_e( 'You can use the following variables:', 'school-management' ); ?></span>
				<div class="row">
					<?php foreach ( $sms_offline_fee_submission_to_parent_placeholders as $key => $value ) { ?>
	...
	<div class="wlsm_sms_template wlsm_sms_offline_fee_submission_to_parent">
		<div class="row">
			<div class="col-md-3">
				<label for="wlsm_sms_offline_fee_submission_to_parent_message" class="wlsm-font-bold"><?php esc_html_e( 'SMS Message', 'school-management' ); ?>:</label>
			</div>
			<div class="col-md-9">
				<div class="form-group">
	...
	<?php
	$sms_template = 'offline_fee_submission_to_parent';
