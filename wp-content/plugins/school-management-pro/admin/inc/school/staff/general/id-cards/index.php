	...
	<div class="col-md-12">
		<div class="mt-2 text-center wlsm-section-heading-block">
			<span class="wlsm-section-heading">
				...
				<?php esc_html_e( 'Print ID Cards in Bulk', 'school-management' ); ?>
			</span>
		</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-4">
									...
									<select name="only_active" class="form-control selectpicker" id="wlsm_only_active">
										<option value="1"><?php esc_html_e( 'Active Students', 'school-management' ); ?></option>
										<option value="0"><?php esc_html_e( 'All Students', 'school-management' ); ?></option>
									</select>
								</div>
							</div>
						</div>
