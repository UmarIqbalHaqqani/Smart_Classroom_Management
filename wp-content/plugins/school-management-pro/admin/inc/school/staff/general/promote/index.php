	...
	<div class="col-md-12">
		<div class="mt-2 text-center wlsm-section-heading-block">
			<span class="wlsm-section-heading">
				...
				<?php esc_html_e( 'Student Promotion', 'school-management' ); ?>
			</span>
		</div>
		...
		<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-promote-student-form">
			...
			<div class="wlsm-form-section">
				<div class="alert alert-info">
					<strong><?php esc_html_e( 'Note: ', 'school-management' ); ?></strong>
					<?php esc_html_e( 'Promoting student from the present class to the next class will create an enrollment of that student for the next session.', 'school-management' ); ?>
				</div>

				<div class="row">
					<div class="col-md-12">
						<div class="wlsm-form-sub-heading wlsm-font-bold">
							<?php esc_html_e( 'Promotion', 'school-management' ); ?>
							<br>
							<small class="text-dark">
								<em><?php esc_html_e( 'Select class to promote, next session and new class.', 'school-management' ); ?></em>
							</small>
						</div>
					</div>
				</div>
				...
				<div class="form-row mt-2">
					<div class="form-group col-md-6">
						<div class="wlsm-font-bold mb-2 pb-1"><?php esc_html_e( 'Current Session', 'school-management' ); ?>:</div>
						<div class="ml-1"><?php echo esc_html( $current_session['label'] ); ?></div>
					</div>

					<div class="form-group col-md-6">
						<label class="wlsm-font-bold" for="wlsm-promote-to-session">
							<span class="wlsm-important">*</span> <?php esc_html_e( 'Promote to Session', 'school-management' ); ?>:
						</label>
						<select name="promote_to_session" class="form-control selectpicker" id="wlsm-promote-to-session" data-live-search="true" title="<?php esc_attr_e( 'Select Next Session', 'school-management' ); ?>">
					...
					<div class="form-group col-md-6">
						<label for="wlsm_from_class" class="wlsm-font-bold">
							<span class="wlsm-important">*</span> <?php esc_html_e( 'Promotion From Class', 'school-management' ); ?>:
						</label>
					...
					<div class="form-group col-md-6">
						<label for="wlsm_to_class" class="wlsm-font-bold">
							<span class="wlsm-important">*</span> <?php esc_html_e( 'Promotion To Class', 'school-management' ); ?>:
						</label>
			...
			<div class="row mt-2">
				<div class="col-md-12 text-center">
					<button type="button" class="btn btn-sm btn-primary" id="wlsm-manage-promotion-btn" data-nonce="<?php echo esc_attr( wp_create_nonce( 'manage-promotion' ) ); ?>">
						<?php esc_html_e( 'Manage Promotion', 'school-management' ); ?>
					</button>
				</div>
			</div>
