    ...
    <div class="tidio-notice-wrapper notice notice-info">
        <div class="notice-content">
            ...
            <section>
                <p class="header">
                    <strong>
                        <?php I18n::_e('Meet Lyro - the conversational AI chatbot for your website'); ?>
                    </strong>
                </p>
                <p>
                    <?php I18n::_e('WordPress users will be able to automatically solve up to 70% customer problems with Lyro - Tidio’s latest AI chatbot. <strong>Try it out with 50 free AI-driven conversations.</strong>'); ?>
                </p>
            </section>
            <a class="link button" target="_blank" href="https://www.tidio.com/lyro/?utm_source=platform&utm_medium=wordpress&utm_campaign=backeend-notice&utm_term=Get%2050%20free%20Lyro%20conversations"><?php I18n::_e('Get 50 free Lyro conversations'); ?></a>
        </div>
