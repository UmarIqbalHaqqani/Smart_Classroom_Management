...
$settings = get_option("wppm-ap-individual-task");
$wppm_ap_settings = get_option("wppm-ap-settings");
?>
<form action="#" onsubmit="return false;" class="wppm-frm-ap-individual_tl">
    ...
    <input type="hidden" name="action" value="wppm_set_ap_individual_task">
    <input type="hidden" name="_ajax_nonce" value="<?php echo esc_attr( wp_create_nonce( 'wppm_set_ap_individual_task' ) ); ?>">
...
<div class="setting-footer-actions">
    <button 
        ...
        onclick="wppm_set_ap_individual_task();" style="background-color:<?php echo esc_attr($wppm_ap_settings['save-changes-button-bg-color'])?>!important;color:<?php echo esc_attr($wppm_ap_settings['save-changes-button-text-color'])?>!important;">
        <?php esc_attr_e( 'Save Changes', 'taskbuilder' ); ?></button>
    <button 
        class="wppm_reset_btn" id="wppm_reset_ap_individual_task_btn"
        onclick="wppm_reset_ap_individual_task(this);">
    <?php esc_attr_e( 'Reset default', 'taskbuilder' ); ?></button>
    <input type="hidden" name="wppm_reset_ap_individual_task_ajax_nonce" id="wppm_reset_ap_individual_task_ajax_nonce" value="<?php echo esc_attr( wp_create_nonce( 'wppm_reset_ap_individual_task' ) ); ?>">
