...
foreach ($wppm_email_notificatins as $key=>$val) :
  if($val['type']=='change_task_assign_users'){
    ...
    $email_addresses = apply_filters('wppm_en_project_assign_users_email_addresses',$email_addresses,$val,$task_id);
    ...
    do_action('wppm_after_task_change_users_mail',$task_id,$val);
  }
endforeach;
