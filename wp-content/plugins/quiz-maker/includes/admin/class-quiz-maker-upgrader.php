...
class QuizMakerPluginSilentUpgrader extends \Plugin_Upgrader {
	...
	public function install_package( $args = [] ) {
		...
		self::ays_quiz_maker_set_time_limit( 300 );
     ...
     */
    public static function ays_quiz_maker_set_time_limit( $limit = 0 ) {
