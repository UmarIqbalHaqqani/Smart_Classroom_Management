...
function sixth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			/*background-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg3.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
		...
		#login:after{
			...
			top: 0;
			height: 100%;
			background-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg6.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
