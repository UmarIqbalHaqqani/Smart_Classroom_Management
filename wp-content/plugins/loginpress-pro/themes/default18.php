<?php
/**
 * LoginPress Theme Name: Animated Wapo
 *
 * @package LoginPress Pro
 */
function eighteenth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			background-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg18.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
