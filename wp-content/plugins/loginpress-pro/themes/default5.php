...
function fifth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			background-image: url(<?php echo plugins_url( 'assets/img/bg5.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
		...
		#login{
			...
			background-image: url(<?php echo plugins_url( 'assets/img/form_bg5.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
			background-size: cover;
