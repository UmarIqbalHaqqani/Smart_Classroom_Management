<?php
/**
 * LoginPress Theme Name: Shopping
 *
...
function twelfth_presets() {
	...
	<style media="screen" id="loginpress-style">
		...
		body.login {
			background-image: url(<?php echo esc_url( plugins_url( 'assets/img/bg12.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
		...
		.login label[for="user_pass"]:after{
			background-image: url(<?php echo esc_url( plugins_url( 'assets/img/login-field-icons.svg', LOGINPRESS_PRO_PLUGIN_BASENAME ) ); ?>);
		}
		.login label[for="user_login"]:after{
