        ...
        <tr>
          ...
          <td class="border-0 full_name_header">
            ...
            <tr>
                ...
                <th>@if(isset($payrollDetails)){{currency_format($payrollDetails->basic_salary)}} @endif</th>
            </tr>
            <tr>
                <th>@lang('hr.gross_salary')</th>
                <th> @if(isset($payrollDetails)){{currency_format($payrollDetails->gross_salary)}} @endif</th>
                <th>@lang('hr.net_salary')</th>
                <th>@if(isset($payrollDetails)){{currency_format($payrollDetails->net_salary)}} @endif</th>
            </tr>
            <tr>
                <th>@lang('hr.paid')</th>                
                <th>@if(isset($payrollDetails)){{currency_format($payrollDetails->payrollPayments->sum('amount'))}} @endif</th>
            </tr>
