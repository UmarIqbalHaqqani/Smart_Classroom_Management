                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-lg-6 ml-30">
                                                ...
                                                <p class="text-white mb-0"> @lang('common.email')  {{isset($email)?$email:'hello@aorasoft.com'}} ,  @lang('common.phone')  {{isset(generalSetting()->phone)?generalSetting()->phone:'hello@aorasoft.com'}} </p> 
                                            </div>
                                            <div class="offset-2">
