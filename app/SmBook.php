...
class SmBook extends Model
{
    ...
    {
        return $this->belongsTo('App\SmBookCategory', 'book_category_id', 'id')->withoutGlobalScopes();
    }

    public function bookSubjectApi()
    {
        return $this->belongsTo('App\LibrarySubject', 'book_subject_id', 'id')->withoutGlobalScopes();
    }
