...
class SmStaffAttendanceController extends Controller
{
    ...
    public function staffAttendance(Request $request)
    {
        ...
        try {
            $roles = InfixRole::where('is_saas',0)->where('active_status', '=', '1')->whereNotIn('id', [1, 2, 3])->where(function ($q) {
    ...
    public function staffAttendanceSearch(staffAttendanceSearchRequest $request)
    {
        try {
            ...
            $roles = InfixRole::where('is_saas',0)->where('active_status', '=', '1')->whereNotIn('id', [1, 2, 3])->whereOr(['school_id', Auth::user()->school_id], ['school_id', 1])->get();
    ...
    public function staffAttendanceReportSearch(staffAttendanceReportSearchRequest $request)
    {
        try {
            ...
            $roles = InfixRole::where('is_saas',0)->whereNotIn('id', [1, 2, 3])->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
