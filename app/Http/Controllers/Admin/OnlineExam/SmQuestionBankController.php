...
class SmQuestionBankController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            $banks  = SmQuestionBank::where([['class_id', '!=', null],['section_id', '!=', null]])->withOutGlobalScope(StatusAcademicSchoolScope::class)
                    ->with('class', 'section', 'questionMu', 'questionGroup')->get();
            ...
            return view('backEnd.examination.question_bank', compact('banks', 'groups', 'classes', 'sections'));
        } catch (Exception $e) {
            toastrError();
    ...
    public function show($id)
    {
        try {
            ...
            return view('backEnd.examination.question_bank', compact('groups', 'banks', 'bank', 'classes', 'sections', 'editData'));
        } catch (Exception $e) {
            toastrError();
            return redirect()->back();
        }
