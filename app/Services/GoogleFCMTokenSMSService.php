...
class GoogleFCMTokenSMSService
{
    ...
    {
        $filePath = storage_path('app/' . SaasDomain() . '-sms-firebase-service-account.json');
    ...
    protected function createCredentialsFile()
    {
        ...
        Storage::put( SaasDomain() . '-sms-firebase-service-account.json', json_encode($defaultContent, JSON_PRETTY_PRINT));
    }
